...
<template>
  <form @submit.prevent="submit" class="p-4 w-full mx-auto md:w-[80%]">    
    ...
    <div class="mt-4 px-2 border-gray-100 flex justify-end space-x-2">
      <button :isDisabled='sending' class="bg-[#EA5165] hover:bg-[#D54A5C] transition-all text-white font-bold w-full text-center mt-4 h-[40px] grid place-items-center rounded-3xl">
