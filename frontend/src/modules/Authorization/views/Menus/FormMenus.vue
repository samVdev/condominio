...
<template>
  <form @submit.prevent="submit" class="bg-white p-5 relative w-full md:w-[30%]">
    ...
    <button type="submit"
      class="inline-flex justify-center mt-5 w-full rounded-md border border-transparent px-4 py-2 bg-[#e2384f] text-base leading-6 font-medium text-white shadow-sm hover:bg-[#a7404e] transition ease-in-out duration-150 sm:text-sm sm:leading-5">
      Actualizar
    </button>
  </form>
</template>
