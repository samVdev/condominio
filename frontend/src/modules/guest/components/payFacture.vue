    ...
    <div class="w-full max-w-md rounded-2xl bg-card shadow-xl overflow-hidden transition-all duration- bg-white">
            ...
            <div class="rounded-2xl shadow-xl overflow-hidden mb-6">
                <div class="p-4 flex items-center text-white justify-between bg-[#e2384fd2]">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="font-medium">Banco de venezuela</h3>
                    </div>
                </div>
                <div class="p-4 space-y-3">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="font-medium">Jorgue asj</span>
                            <button @click="() => copyToClipboard('asldkhasld', 'Titular')"
                                class="text-[#e2384fd2] hover:text-[#e2384f]"
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="font-medium tracking-wider">123810293901289312</span>
                            <button @click="() => copyToClipboard('1982', 'Número de cuenta')"
                                class="text-[#e2384fd2] hover:text-[#e2384f]"
        ...
        <div class="grid grid-cols-1 gap-2 md:grid-cols-2">
            <div class="mb-6">
                ...
                <input class="text-2xl font-bold" name="cedula" maxlength="8" type="text" placeholder="00.000.000" v-model="paymentForm.cedula" required>
            </div>
            ...
            <div class="mb-6">
                ...
                <input class="text-2xl font-bold"  name="ref" type="text" placeholder="123456" maxlength="6" v-model="paymentForm.ref" required>
            </div>
        </div>
            ...
            <div class="mb-6">
                ...
                <input class="text-2xl font-bold" type="text" name="dol"  :value="parsePrices(facture.total).dol" required disabled>
            </div>
            ...
            <div class="mb-6">
                ...
                <input class="text-2xl font-bold" type="text" name="bs" :value="parsePrices(facture.dollar_bcv).bs" required disabled>
            </div>
            ...
            <button class="flex bg-[#e2384f] items-center justify-center gap-2 mx-auto text-sm font-medium border h-12 rounded-xl w-[60%] transition-all-200 hover:bg-red-500 text-white">
                Pagar
