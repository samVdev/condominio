...
class FactureUserCompletedService
{
    public static function index(Request $request): JsonResponse
    {
        try {
            ...
            $factures = $facturesDB->map(function ($expense) use ($dolar) {
                ...
                $alicuota = floatval($expense->porcent_alicuota ?? 0);
                ...
                $info = [
                    ...
                    'alicuot' => floatval($expense->porcent_alicuota),
                    'total' => $mountDollars,
